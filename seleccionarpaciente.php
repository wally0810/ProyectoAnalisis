...
<body style="margin: 50px;">
     <!-- mostramos datos en tabla para seleccionar paciente y mandarlos al formulario ingresarficha-->
    <h1><a href="especialistas.php"> Lista De Paciente</a></h1>
    <table class="table">
    <thead>
    <tr>
        <th>Id Paciente</th>
    ...
    <tbody>
      ...
      ?>
        <tr>
            ...
            <td>
               <!-- mandamos los datos del paciente al formulario donde ingresamos las fichas medicas -->
            <a class='btn btn-primary btn btn-sm' href="ingresarexamen.php?
